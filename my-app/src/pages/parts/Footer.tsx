    ...
    <footer className="bg-black text-white py-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 pt-8 border-t border-gray-700 text-center text-sm">
          <p className="text-center">© 2024 Sam K. H. Tam. All rights reserved.</p>
          <p className="mt-2 text-center">
            This website was created in collaboration with <a href="https://v0.dev" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300">v0.dev</a>, an AI-powered design tool. <br></br>
